---
layout: post
title: "Understanding x86 Assembly Line by Line: Stack Frames, Calling Conventions, ABIs and More"
date: 2026-09-12
...
Here, we will analyze an executable from <a href="https://github.com/mandiant/flare-learning-hub/tree/main/macc" target="_blank" rel="noopener noreferrer">Flare Learning Hub / MACC Labs</a>, line by line. Our aim is not to answer the questions in the lab. After we analyze the executable, these will already be a piece of cake.
